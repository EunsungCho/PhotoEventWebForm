                        ...
                        <tr>
                            ...
                            <td style="width: 30%;">
                                <asp:GridView ID="gvWonEvent" runat="server" AutoGenerateColumns="false">
                                    <Columns>
                                        <asp:HyperLinkField DataNavigateUrlFields="EventName" DataNavigateUrlFormatString="EventDetails.aspx?eventid={0}" HeaderText="Event Title" DataTextField="EventName" />
                                    </Columns>
                                </asp:GridView>
                            </td>
