...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <table>
        ...
        <tr>
            <td colspan="2" style="text-align:center;"><asp:Button ID="btnCreateUser" runat="server" Text="Create New User ID" OnClientClick="hideCheckIdLabel()" OnClick="btnCreateUser_Click" /></td>
            <td></td>
        </tr>
        <%--<tr>
            <td></td>
